...
namespace KafeRest.Areas.Admin.Controllers
{
    ...
    public class BlogController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Name,Email,Image,Message,History,IsAgree")] Blog blog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Name,Email,Image,Message,History,IsAgree")] Blog blog)
        {
            if (id != blog.Id)
            {
                return NotFound();
