...
namespace KafeRest.Areas.Admin.Controllers
{
    ...
    public class ReservationController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,PhoneNumber,Count,Clock,History")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,PhoneNumber,Count,Clock,History")] Reservation reservation)
        {
